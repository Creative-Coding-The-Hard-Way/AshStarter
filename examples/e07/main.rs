...
impl State for TextureExample {
    fn new(window: &mut GlfwWindow) -> Result<Self> {
        ...
        unsafe {
            ...
            render_device
                .device()
                .cmd_pipeline_barrier2(command_buffer, &dependency_info_before);
            ...
            render_device
                .device()
                .cmd_pipeline_barrier2(command_buffer, &dependency_info_after);

            render_device.device().end_command_buffer(command_buffer)?;
        };
        ...
        unsafe {
            ...
            render_device.device().destroy_fence(fence, None);
        };
